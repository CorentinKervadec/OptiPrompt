    ...
    for prompt_file in all_prompt_files:
        ...
        for relation in relation_list:
            ...
            if 'paraphrase' in prompt_file:
                ...
                template_list = ['[X]'+''.join([model.tokenizer.decode(random.randint(0, len(model.vocab)-1)) for _ in range(5)])+'[Y]' for z in range(10)]
            ...
            for template in template_list:
                ...
                micro, result, fc1_act, ppl, ent, preds, k_dist = analyze(model, eval_samples_batches, eval_sentences_batches, filter_indices, index_list, output_topk=None)
